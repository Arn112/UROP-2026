...
/* package tasty-bench-0.5.1 */
#ifndef VERSION_tasty_bench
#define VERSION_tasty_bench "0.5.1"
...
#define CURRENT_COMPONENT_ID "simple-0.1.0.0-inplace-ann-bench"
