...
-- at runtime using the environment variable simple_bindir.
...
-- environment variable simple_libdir.
...
-- using the environment variable simple_dynlibdir.
...
-- runtime using the environment variable simple_datadir.
...
-- using the environment variable simple_sysconfdir.
...
bindir     = "/Users/arnavmaniyar/.cabal/bin"
libdir     = "/Users/arnavmaniyar/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace/simple-0.1.0.0-inplace-ann-bench"
dynlibdir  = "/Users/arnavmaniyar/.cabal/lib/aarch64-osx-ghc-9.12.2-inplace"
datadir    = "/Users/arnavmaniyar/.cabal/share/aarch64-osx-ghc-9.12.2-inplace/simple-0.1.0.0"
libexecdir = "/Users/arnavmaniyar/.cabal/libexec/aarch64-osx-ghc-9.12.2-inplace/simple-0.1.0.0"
sysconfdir = "/Users/arnavmaniyar/.cabal/etc"

getBinDir     = catchIO (getEnv "simple_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "simple_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "simple_dynlibdir")  (\_ -> return dynlibdir)
