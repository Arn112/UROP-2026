...
cabal run ann-bench -- +RTS -hy -l-agu -i0.01  (last parameter is optional)
eventlog2html ann-bench.eventlog
open -a 'Brave Browser' ann-bench.eventlog.html
